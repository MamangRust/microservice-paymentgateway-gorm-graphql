...
func (s *cardCommandService) CreateCard(ctx context.Context, request *requests.CreateCardRequest) (*models.Card, error) {
	...
	if err != nil {
		status = "error"
		return sharederrorhandler.HandleError[*models.Card](s.logger, err, method, span, zap.Int("user_id", request.UserID))
	}
	...
	if s.kafka != nil {
		go func() {
			...
			if err != nil {
				s.logger.Error("failed to marshal saldo payload for new card", zap.Error(err))
				return
			}
			_ = s.kafka.SendMessage("saldo-service-topic-create-saldo", strconv.Itoa(int(res.CardID)), payloadBytes)
			...
			if err != nil {
				s.logger.Error("failed to marshal card stats event", zap.Error(err))
			} else {
	...
	logSuccess("Successfully created card", zap.Int("card.id", int(res.CardID)))
	return res, nil
}

func (s *cardCommandService) UpdateCard(ctx context.Context, request *requests.UpdateCardRequest) (*models.Card, error) {
	...
	if err != nil {
		status = "error"
		return sharederrorhandler.HandleError[*models.Card](s.logger, err, method, span, zap.Int("card_id", request.CardID))
	}
...
func (s *cardCommandService) TrashedCard(ctx context.Context, card_id int) (*models.Card, error) {
...
func (s *cardCommandService) RestoreCard(ctx context.Context, card_id int) (*models.Card, error) {
...
func (s *cardCommandService) DeleteCardPermanent(ctx context.Context, card_id int) (bool, error) {
	...
	if err != nil {
		status = "error"
		return sharederrorhandler.HandleError[bool](s.logger, err, method, span, zap.Int("card_id", card_id))
	}
...
func (s *cardCommandService) RestoreAllCard(ctx context.Context) (bool, error) {
	...
	if err != nil {
		status = "error"
		return sharederrorhandler.HandleError[bool](s.logger, sharedErrors.ErrFailed("restore all cards"), method, span)
	}
...
func (s *cardCommandService) DeleteAllCardPermanent(ctx context.Context) (bool, error) {
	...
	if err != nil {
		status = "error"
		return sharederrorhandler.HandleError[bool](s.logger, sharedErrors.ErrFailed("delete all cards permanently"), method, span)
	}
	logSuccess("Successfully deleted all cards permanently")
	return true, nil
}

func (s *cardCommandService) ToggleCardStatus(ctx context.Context, request *requests.ToggleCardStatusRequest) (*models.Card, error) {
	...
	s.cache.DeleteCardCommandCache(ctx, request.CardID)
	logSuccess("Successfully toggled card status", zap.Int("card_id", request.CardID))
	return res, nil
}

func (s *cardCommandService) UpdateCreditLimit(ctx context.Context, request *requests.UpdateCreditLimitRequest) (*models.Card, error) {
	...
	s.cache.DeleteCardCommandCache(ctx, request.CardID)
	logSuccess("Successfully updated credit limit", zap.Int("card_id", request.CardID))
	return res, nil
}

func (s *cardCommandService) RedeemPoints(ctx context.Context, request *requests.RedeemPointsRequest) (*models.Card, error) {
	...
	s.cache.DeleteCardCommandCache(ctx, request.CardID)
	logSuccess("Successfully redeemed reward points", zap.Int("card_id", request.CardID))
	return res, nil
}
