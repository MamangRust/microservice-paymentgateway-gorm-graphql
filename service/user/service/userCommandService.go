...
func (s *userCommandService) TrashedUser(ctx context.Context, user_id int) (*models.User, error) {
...
func (s *userCommandService) RestoreUser(ctx context.Context, user_id int) (*models.User, error) {
...
func (s *userCommandService) UpdateIsVerified(ctx context.Context, userID int, isVerified bool) (*models.User, error) {
...
func (s *userCommandService) UpdatePassword(ctx context.Context, userID int, password string) (*models.User, error) {
