...
func (r *roleQueryCache) SetCachedRoles(ctx context.Context, req *requests.FindAllRoles, data []*models.Role, total *int) {
	if total == nil {
		zero := 0
		total = &zero
	}
...
func (r *roleQueryCache) GetCachedRoles(ctx context.Context, req *requests.FindAllRoles) ([]*models.Role, *int, bool) {
	key := fmt.Sprintf(roleAllCacheKey, req.Page, req.PageSize, req.Search)
...
func (r *roleQueryCache) SetCachedRoleActive(ctx context.Context, req *requests.FindAllRoles, data []*models.Role, total *int) {
	if total == nil {
		zero := 0
		total = &zero
	}
...
func (r *roleQueryCache) GetCachedRoleActive(ctx context.Context, req *requests.FindAllRoles) ([]*models.Role, *int, bool) {
	key := fmt.Sprintf(roleActiveCacheKey, req.Page, req.PageSize, req.Search)
...
func (r *roleQueryCache) SetCachedRoleTrashed(ctx context.Context, req *requests.FindAllRoles, data []*models.Role, total *int) {
	if total == nil {
		zero := 0
		total = &zero
	}
...
func (r *roleQueryCache) GetCachedRoleTrashed(ctx context.Context, req *requests.FindAllRoles) ([]*models.Role, *int, bool) {
	key := fmt.Sprintf(roleTrashedCacheKey, req.Page, req.PageSize, req.Search)
