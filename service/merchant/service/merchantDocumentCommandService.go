...
func (s *merchantDocumentCommandService) CreateMerchantDocument(ctx context.Context, request *requests.CreateMerchantDocumentRequest) (*models.MerchantDocument, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*models.MerchantDocument](s.logger, err, method, span, zap.Int("merchant_id", request.MerchantID))
	}

	user, err := s.userAdapter.FindById(ctx, int(merchant.UserID))
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*models.MerchantDocument](s.logger, err, method, span, zap.Int("user_id", int(merchant.UserID)))
	}
...
func (s *merchantDocumentCommandService) UpdateMerchantDocument(ctx context.Context, request *requests.UpdateMerchantDocumentRequest) (*models.MerchantDocument, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*models.MerchantDocument](s.logger, err, method, span, zap.Int("document_id", *request.DocumentID))
	}
