...
func (s *merchantDocumentQueryService) FindAll(ctx context.Context, req *requests.FindAllMerchantDocuments) ([]*models.MerchantDocument, *int, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*models.MerchantDocument](s.logger, err, method, span, zap.String("search", search))
	}

	totalCount, err := s.queryRepo.CountAllDocuments(ctx, search)
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*models.MerchantDocument](s.logger, err, method, span, zap.String("search", search))
	}
	...
	s.cache.SetCachedMerchantDocuments(ctx, req, merchantDocuments, &total)
...
func (s *merchantDocumentQueryService) FindById(ctx context.Context, documentID int) (*models.MerchantDocument, error) {
	...
	if err != nil {
		status = "error"
		return errorhandler.HandleError[*models.MerchantDocument](s.logger, err, method, span, zap.Int("merchantDocument.id", documentID))
	}
...
func (s *merchantDocumentQueryService) FindByActive(ctx context.Context, req *requests.FindAllMerchantDocuments) ([]*models.MerchantDocument, *int, error) {
	...
	totalCount, err := s.queryRepo.CountActiveDocuments(ctx, search)
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*models.MerchantDocument](s.logger, err, method, span, zap.String("search", search))
	}
	...
	total := int(totalCount)
	s.cache.SetCachedMerchantDocumentsActive(ctx, req, merchantDocuments, &total)
...
func (s *merchantDocumentQueryService) FindByTrashed(ctx context.Context, req *requests.FindAllMerchantDocuments) ([]*models.MerchantDocument, *int, error) {
	...
	totalCount, err := s.queryRepo.CountTrashedDocuments(ctx, search)
	if err != nil {
		status = "error"
		return errorhandler.HandlerErrorPagination[[]*models.MerchantDocument](s.logger, err, method, span, zap.String("search", search))
	}
	...
	total := int(totalCount)
	s.cache.SetCachedMerchantDocumentsTrashed(ctx, req, merchantDocuments, &total)
