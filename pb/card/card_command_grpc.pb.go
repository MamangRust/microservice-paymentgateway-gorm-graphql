...
func (UnimplementedCardCommandServiceServer) ToggleCardStatus(context.Context, *ToggleCardStatusRequest) (*ApiResponseCard, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ToggleCardStatus not implemented")
}
func (UnimplementedCardCommandServiceServer) UpdateCreditLimit(context.Context, *UpdateCreditLimitRequest) (*ApiResponseCard, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateCreditLimit not implemented")
}
...
func (UnimplementedCardCommandServiceServer) ProcessBillingCycles(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ProcessBillingCycles not implemented")
}
